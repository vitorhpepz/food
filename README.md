...
```
Enter your OpenAI API key in the UI (kept in localStorage). You can open `index.html` directly, but service worker/manifest and camera prompts work best from localhost/HTTPS.
